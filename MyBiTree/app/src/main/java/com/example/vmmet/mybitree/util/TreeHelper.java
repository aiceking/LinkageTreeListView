package com.example.vmmet.mybitree.util;
...
public class TreeHelper {
    ...
    public static  List<Node> getAllNodes(){
        ...
        for (int i=0;i<100;i++){
        nodes.add(new Node("5","2","英雄联盟"+i));
        nodes.add(new Node("6","3","贝加尔湖畔"+i));
        nodes.add(new Node("7","3","克罗地亚狂想曲"+i));
        nodes.add(new Node("8","4","无法触碰"+i));
        nodes.add(new Node("9","4","返老还童"+i));}
//        //第二个树的模拟数据
